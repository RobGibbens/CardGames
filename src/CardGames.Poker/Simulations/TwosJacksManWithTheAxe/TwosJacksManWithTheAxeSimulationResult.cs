...
/// <summary>
/// Contains the results of a TwosJacksManWithTheAxe simulation.
/// </summary>
public class TwosJacksManWithTheAxeSimulationResult
{
    private readonly int _nrOfHands;

    public TwosJacksManWithTheAxeSimulationResult(int nrOfHands, IReadOnlyCollection<IDictionary<string, DrawHand>> hands)
    {

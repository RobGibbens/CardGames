...
public class FollowTheQueenGame
{
        ...
        int bigBet)
    {
        ...
        {
            throw new ArgumentException($"Follow the Queen requires at least {MinPlayers} players");
        }

        if (playerList.Count > MaxPlayers)
        {
            throw new ArgumentException($"Follow the Queen supports at most {MaxPlayers} players");
        }

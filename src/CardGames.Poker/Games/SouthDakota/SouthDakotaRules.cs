...
/// <summary>
/// Provides game rules metadata for South Dakota.
/// </summary>
public static class SouthDakotaRules
{
    public static GameRules CreateGameRules()
    {
        return new GameRules
        {
            GameTypeCode = "SOUTHDAKOTA",
            GameTypeName = "South Dakota",
            Description = "A community card game similar to Nebraska, but with a two-card flop, a turn, and no river. Players must use exactly three hole cards with exactly two community cards.",
            MinPlayers = 2,
            MaxPlayers = 10,
            Phases = new List<GamePhaseDescriptor>
            {
                ...
                new() { PhaseId = "Flop", Name = "Flop", Description = "First 2 community cards", Category = "Betting", RequiresPlayerAction = true },
                new() { PhaseId = "Turn", Name = "Turn", Description = "3rd community card", Category = "Betting", RequiresPlayerAction = true },
            ...
            CardDealing = new CardDealingConfig
            {
                ...
                DealingRounds = new List<DealingRound>
                {
                    ...
                    new() { CardCount = 2, Visibility = CardVisibility.FaceUp, Target = DealingTarget.Community },

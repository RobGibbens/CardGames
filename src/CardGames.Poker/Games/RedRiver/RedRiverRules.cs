...
/// <summary>
/// Provides game rules metadata for Red River.
/// </summary>
public static class RedRiverRules
{
    public static GameRules CreateGameRules()
    {
        return new GameRules
        {
            ...
            Phases = new List<GamePhaseDescriptor>
            {
                ...
                new() { PhaseId = "River", Name = "River", Description = "5th community card, with a possible bonus board card", Category = "Betting", RequiresPlayerAction = true },

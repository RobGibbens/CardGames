...
public sealed record HandHistoryPlayerResultDto
{
    ...
    /// </summary>
    public required PlayerFinalAction FinalAction { get; init; }
...
public sealed record HandHistoryEntryWithPlayersDto
{
    ...
    /// </summary>
    public required int TotalPotAmount { get; init; }
    ...
    /// </summary>
    public required IReadOnlyList<HandHistoryPlayerResultDto> PlayerResults { get; init; }
}
...
public sealed record HandHistoryWithPlayersListDto
{
    ...
    /// </summary>
    public required IReadOnlyList<HandHistoryEntryWithPlayersDto> Entries { get; init; }

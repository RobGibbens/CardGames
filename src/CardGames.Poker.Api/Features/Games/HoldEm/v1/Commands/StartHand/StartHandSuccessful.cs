...
/// <summary>
/// Represents a successful start of a new hand in a Texas Hold 'Em game.
/// </summary>
public record StartHandSuccessful
{
	...
	/// <summary>
	/// The number of active players in the started hand.
	/// </summary>
...
public enum StartHandErrorCode
{
	...
	/// <summary>
	/// Not enough players are eligible to start the hand.
	/// </summary>
	NotEnoughPlayers
}

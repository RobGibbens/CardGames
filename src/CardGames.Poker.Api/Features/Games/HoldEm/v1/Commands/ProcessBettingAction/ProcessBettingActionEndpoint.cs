...
/// <summary>
/// Endpoint for processing betting actions in a Texas Hold 'Em game.
/// </summary>
public static class ProcessBettingActionEndpoint
{
	...
	public static RouteGroupBuilder MapProcessBettingAction(this RouteGroupBuilder group)
	{
		group.MapPost("{gameId:guid}/betting/actions",
			...
			.WithName($"HoldEm{nameof(MapProcessBettingAction).TrimPrefix("Map")}")
			...
			.WithDescription(
				...
				"the game automatically advances to the next phase and deals community cards.\n\n" +
				"**Action Types:**\n" +

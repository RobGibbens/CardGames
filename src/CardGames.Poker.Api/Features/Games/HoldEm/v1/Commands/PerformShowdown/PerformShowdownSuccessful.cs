...
/// <summary>
/// Represents a successful showdown result for a Texas Hold'Em hand.
/// </summary>
...
public record ShowdownPlayerHand
{
	...
	/// <summary>
	/// The cards the player held (hole cards + community cards).
	/// </summary>
	...
	/// In Hold'Em, players have 2 hole cards + 5 community cards but only 5 count toward the winning hand.
	/// </summary>

...
namespace CardGames.Poker.Api.Features.Games.TwosJacksManWithTheAxe.v1.Queries.GetGamePlayers;
...
public static class GetGamePlayersEndpoint
{
	public static RouteGroupBuilder MapGetGamePlayers(this RouteGroupBuilder group)
	{
		group.MapGet("{gameId:guid}/players",
			...
			.WithName($"TwosJacksManWithTheAxe{nameof(MapGetGamePlayers).TrimPrefix("Map")}")

...
namespace CardGames.Poker.Api.Features.Games.TwosJacksManWithTheAxe.v1.Queries.GetHandHistory;
...
public static class GetHandHistoryEndpoint
{
    ...
    public static RouteGroupBuilder MapGetHandHistory(this RouteGroupBuilder group)
    {
        group.MapGet("{gameId:guid}/history",
            ...
            .WithName($"TwosJacksManWithTheAxe{nameof(MapGetHandHistory).TrimPrefix("Map")}")

...
namespace CardGames.Poker.Api.Features.Games.TwosJacksManWithTheAxe.v1.Queries.GetGame;
...
public static class GetGameEndpoint
{
	public static RouteGroupBuilder MapGetGame(this RouteGroupBuilder group)
	{
		group.MapGet("{gameId:guid}",
			...
			.WithName($"TwosJacksManWithTheAxe{nameof(MapGetGame).TrimPrefix("Map")}")

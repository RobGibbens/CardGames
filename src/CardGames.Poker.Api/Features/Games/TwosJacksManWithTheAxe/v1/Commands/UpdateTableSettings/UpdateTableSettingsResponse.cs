namespace CardGames.Poker.Api.Features.Games.TwosJacksManWithTheAxe.v1.Commands.UpdateTableSettings;

/// <summary>
/// Response for updating table settings.
/// </summary>
public sealed record UpdateTableSettingsResponse
{
    /// <summary>

...
namespace CardGames.Poker.Api.Features.Games.TwosJacksManWithTheAxe.v1.Commands.CollectAntes;
...
public static class CollectAntesEndpoint
{
	...
	public static RouteGroupBuilder MapCollectAntes(this RouteGroupBuilder group)
	{
		group.MapPost("{gameId:guid}/hands/antes",
			...
			.WithName($"TwosJacksManWithTheAxe{nameof(MapCollectAntes).TrimPrefix("Map")}")

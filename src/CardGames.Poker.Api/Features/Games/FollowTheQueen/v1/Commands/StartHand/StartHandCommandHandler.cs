...
/// <summary>
/// Handles the <see cref="StartHandCommand"/> to start a new hand in a Follow the Queen game.
/// </summary>
	...
	: IRequestHandler<StartHandCommand, OneOf<StartHandSuccessful, StartHandError>>
{
		...
		CancellationToken cancellationToken)
	{
		...
		// 6. Reset player states for new hand
		...
		// 7. Remove any existing cards from previous hand
		...
		// 8. Create and persist shuffled deck for this hand
		...
		// 9. Create a new main pot for this hand
		var mainPot = new Pot
		{
			GameId = game.Id,
			HandNumber = newHandNumber,

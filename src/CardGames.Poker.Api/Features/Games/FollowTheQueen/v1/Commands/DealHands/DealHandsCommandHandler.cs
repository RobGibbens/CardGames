...
/// <summary>
/// Handles the <see cref="DealHandsCommand"/> to deal cards for the current Follow the Queen street.
/// </summary>
	...
	: IRequestHandler<DealHandsCommand, OneOf<DealHandsSuccessful, DealHandsError>>
{
		...
		CancellationToken cancellationToken)
	{
		...
		// 2. Validate game state - Follow the Queen deals cards during street phases
		var validPhases = new[]
		{

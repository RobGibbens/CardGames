...
public class SevenCardStudDealHandsCommandHandlerTests : IntegrationTestBase
{
    [Fact]
    public async Task DealHands_ThirdStreet_UsesLowestUpCardForFirstActor()
    {
        var setup = await DatabaseSeeder.CreateCompleteGameSetupAsync(DbContext, "SEVENCARDSTUD", 2, ante: 10);

...
internal class FiveCardDrawPlayCommand : Command<PlaySettings>
{
    ...
    private static void PlayHand(FiveCardDrawGame game)
    {
    ...
    private static void DisplayPlayerStacks(FiveCardDrawGame game)
    {
        var table = new Table();
    ...
    private static void DisplayPlayerStatus(FiveCardDrawGame game, PokerPlayer currentPlayer)
    {
    ...
    private static void DisplayAllHands(FiveCardDrawGame game)
    {
        foreach (var gamePlayer in game.GamePlayers)
        {
    ...
    private static void DisplayFinalStandings(FiveCardDrawGame game)
    {

...
/// <summary>
/// Response DTO for the GET table settings API endpoint.
/// Used by clients to deserialize the API response.
/// </summary>
public sealed record GetTableSettingsResponse
{
    ...
    /// True only when Phase is WaitingToStart or WaitingForPlayers.
    /// </summary>
    ...
    /// Must be included in update requests.
    /// </summary>

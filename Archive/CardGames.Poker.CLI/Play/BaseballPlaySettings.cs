...
internal class BaseballPlaySettings : PlaySettings
{
    ...
    [Description("Price to buy an extra card when dealt a 4 face up")]
    [CommandOption("--buy-card-price")]
    public int BuyCardPrice { get; set; } = 20;
}

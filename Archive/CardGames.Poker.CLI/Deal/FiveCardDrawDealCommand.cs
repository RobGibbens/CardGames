...
internal class FiveCardDrawDealCommand : Command<DealSettings>
{
    ...
    protected override int Execute(CommandContext context, DealSettings settings, CancellationToken cancellationToken)
    {
        ...
        DealFiveCardDrawHand(playerNames);
    ...
    private static void DealFiveCardDrawHand(List<string> playerNames)
    {
        Logger.Paragraph("Dealing 5-Card Draw Hand");
